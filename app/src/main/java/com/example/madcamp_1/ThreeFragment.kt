...
class ThreeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        eventListView.setOnItemClickListener{
            ...
            et.setText("$selectedItem4")
            val et2 = view.findViewById<EditText>(R.id.Attendee)

            et2.setText("$selectedItem5")
                    ...
                    DialogInterface.OnClickListener { dialog, which ->
                        ...
                        if (events.isNotEmpty()) {
                            if (index != -1) {
                                ...
                                val newEvent =
                                    "Date: $selectedItem3, Restaurant: ${et.text}, Attendee: ${et2.text}"
    ...
    private fun showAddEventDialog() {
        ...
        datePickerButton.setOnClickListener {
            val datePickerDialog = DatePickerDialog(
                requireContext(),
                { _, selectedYear, selectedMonth, selectedDayOfMonth ->
                    restaurantName = restaurantNameEditText.text.toString()
                    attendeeName = attendeeNameEditText.text.toString()
                    year = selectedYear
                    month = selectedMonth
